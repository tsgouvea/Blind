...
sma = AddState(sma, 'Name', 'wait_Sin_early',...
    ...
    'StateChangeConditions', {LeftPortIn,'start_Lin_early',RightPortIn,'start_Rin_early','Tup','ITI'},...
...
sma = AddState(sma, 'Name', 'wait_Sin_late',...
    'Timer',TaskParameters.GUI.ChoiceDeadline,...
    'StateChangeConditions', {LeftPortIn,'start_Lin_late',RightPortIn,'start_Rin_late','Tup','ITI'},...
    'OutputActions',{strcat('PWM',num2str(LeftPort)),255,strcat('PWM',num2str(RightPort)),255});
